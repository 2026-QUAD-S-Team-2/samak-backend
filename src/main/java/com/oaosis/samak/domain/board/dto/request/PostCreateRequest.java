...
public record PostCreateRequest(
        @Schema(description = "게시글 카테고리 (EXPERIENCE: 피해 경험담, FRAUD_VOTE: 사기 의심 투표, AI_ANALYSIS: AI 분석 결과 공유)", example = "EXPERIENCE")
        @NotNull
        ...
        @Schema(description = "분석 아이템 ID (AI_ANALYSIS 카테고리일 때 필수, COMPLETED 상태여야 함)", example = "1")
        Long analysisItemId
) {
}
